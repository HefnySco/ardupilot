...
protected:
    ...
    //MHEFNY::IMPORTANT::Vales determine vehicle motor order and location based on RPYT contribution.
    ...
    //MHEFNY::IMPORTANT::Last values before converting to pwm are hold in this array.
