 ...
 *
 */
class GPIO_BananaPI : public AP_HAL::GPIO {
public:
    GPIO_BananaPI();
    void    init() override;
...
private:
    ...
    int get_pin (const int pin) const ;
     ...
     *  - Linux::GPIO_BananaPI::set_gpio_mode_in
     *  - Linux::GPIO_BananaPI::set_gpio_mode_out
     *
     * @param pin
     */
     ...
     * Check Linux::GPIO_BananaPI::set_gpio_mode_alt for more information.
     *
     * @param pin
     */
     ...
     * Writing zero to this register has no effect, please use Linux::GPIO_BananaPI::set_gpio_low
     * to set pin as low.
     *
     ...
     * Writing zero to this register has no effect, please use Linux::GPIO_BananaPI::set_gpio_high
     * to set pin as high.
     *
