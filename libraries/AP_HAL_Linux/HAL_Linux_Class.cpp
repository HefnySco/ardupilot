...
static RCInput_STM32 rcinDriver(i2c_mgr_instance.get_device(1, STM32_RCINPUT_ADDRESS));
...
//static RCOutput_PCA9685 rcoutDriver(i2c_mgr_instance.get_device(0, PCA9685_PRIMARY_ADDRESS), 0, 0, RPI_GPIO_<17>());
