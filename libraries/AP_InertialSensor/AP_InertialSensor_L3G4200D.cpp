...
AP_InertialSensor_L3G4200D::AP_InertialSensor_L3G4200D(AP_InertialSensor &imu,
    ...
    , _dev_accel(std::move(dev_accel))
{
    //_dev2(std::move(hal.i2c_mgr->get_device(bus, address)));   //MHEFNY
    //AP_HAL::panic2(">>>> HERE 2 ....");
}
                                                            ...
                                                            enum Rotation rotation)
{
    ...
    //AP_HAL::panic2(">>>> OUT BEFORE START ....");
    AP_InertialSensor_L3G4200D *sensor
        = new AP_InertialSensor_L3G4200D(imu, std::move(dev_gyro), std::move(dev_accel), rotation);

    //AP_HAL::panic2(">>>> OUT AFTER START ....");
...
bool AP_InertialSensor_L3G4200D::_accel_init()
{
    ...
    // _dev_accel->write_register(ADXL345_ACCELEROMETER_ADXLREG_POWER_CTL, 0x00);
    // hal.scheduler->delay(5);
    // _dev_accel->write_register(ADXL345_ACCELEROMETER_ADXLREG_POWER_CTL, 0xff);
    // hal.scheduler->delay(5);
    ...
    // _dev_accel->write_register(L3G4200D_REG_CTRL_REG5,
...
{
    //timing_printf("AP_InertialSensor_L3G4200D MHEFNY: STARTED");
